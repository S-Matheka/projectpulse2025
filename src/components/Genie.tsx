...
export const Genie = ({ isOpen, onClose, isDarkMode }: GenieProps) => {
    ...
    const handleSend = (text: string = input) => {
        ...
        setAvailableQuestions(prev => prev.filter(q => q !== text));
    ...
    // Add suggestions message whenever available questions change
    useEffect(() => {
                                ...
                                <div className="mt-2 space-y-2">
                                    {message.suggestions.map((question, qIndex) => (
                                        <button
                                            ...
                                            className={`w-full text-left p-3 text-sm rounded-lg transition-all duration-200 ${isDarkMode
                ...
                <div className={`p-4 border-t ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
                    <div className="flex items-center space-x-2">
                        <input
                            ...
                            className={`flex-1 p-2 rounded-lg transition-colors ${isDarkMode
