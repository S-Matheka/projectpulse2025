...
const data = [
    { name: 'Total Inbound', value: 451, color: '#2563EB' },
    { name: 'Live Calls', value: 252, color: '#059669' },
    { name: 'Voice Mail', value: 147, color: '#D97706' },
    { name: 'Abandoned', value: 52, color: '#DC2626' }
];
